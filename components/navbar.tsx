  ...
  return (
    <>
      <div className="lg:container mx-auto fixed left-0 right-0 pt-[12px] z-40">
        <div className="bg-secondary/50 px-6 py-2 rounded-full flex justify-between items-center gap-[60px] glass-blur">
          <Link href="/">
          ...
          <div className="block lg:hidden">
            <Image src={hamburger} alt="Hamburger Menu" height={24} />
          </div>
        </div>
      </div>
    </>
